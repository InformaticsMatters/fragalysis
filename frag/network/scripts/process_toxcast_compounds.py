...
"""process_toxcast_compounds.py

Processes standardised ToxCast vendor files,
...
Every fragment line that has a ToxCast identifier in the original data set
...
"toxcast-augmented-nodes.csv.gz".
...
logger = logging.getLogger('toxcast')
...
supplier_name = 'ToxCast'
# Prefix for output files
output_filename_prefix = 'toxcast'
...
def extract_vendor_compounds(suppliermol_gzip_file,
    ...
    -   "toxcast-suppliermol-nodes.csv.gz"
    -   "toxcast-suppliermol-supplier-edges.csv.gz"

    The following files are expected to be written elsewhere: -

    -   "toxcast-supplier-nodes.csv.gz"
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Vendor Compound Processor (ToxCast)')
