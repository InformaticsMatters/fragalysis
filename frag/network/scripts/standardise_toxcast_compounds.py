...
"""standardise_toxcast_compounds.py

Processes ToxCast vendor compound files, and generates a 'standard'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Vendor Compound Standardiser (ToxCast)')
    parser.add_argument('vendor_dir',
                        help='The ToxCast vendor directory,'
    ...
    parser.add_argument('vendor_prefix',
                        help='The ChemSpace vendor file prefix,'
                             ' i.e. "list_chemicals". Only files with this prefix'
