...
"""process_chemspace_bb_pricing_compounds.py

Processes standardised ChemSpace vendor files,
that are expected to contain pricing information.
...
def create_cost_node(pack_size, field_value):
    ...
    # "< max"       e.g. "< 1000"
    # "> min"       e.g. "> 50"
    # "min"         e.g. "50"  (single value considered min and max)
    ...
    if field_value.startswith('>'):
        ...
        min_val = max_val = float(field_value)
