...
"V_XCHEM" for all compounds that have been found
...
def extract_vendor_compounds(suppliermol_gzip_file,
    ...
    -   "xchem-suppliermol-nodes.csv.gz"
    -   "xchem-suppliermol-supplier-edges.csv.gz"

    The following files are expected to be written elsewhere: -

    -   "xchem-supplier-nodes.csv.gz"
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Vendor Compound Processor (XChem)')
